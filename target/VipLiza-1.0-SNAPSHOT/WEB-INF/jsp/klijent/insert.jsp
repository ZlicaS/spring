<%-- 
    Document   : insert
    Created on : Jun 28, 2019, 6:52:53 PM
    Author     : Sapsaj
--%>
        ...
        <div class="col-6 col-md-10">
            <div class="list-group" align="center">
                <div class="list-group-item">
                    <b><font size="4"><a href="/klijent/find">Klijenti</a> / Unos </font></b>
                </div>
            </div>
            <br><br>  
            <div class="container-fluid">

                <form:form action="/klijent/insert" method="post" modelAttribute="klijent">
                    ...
                    <div class="form-group">
                        ...
                        <form:input path="pib" class="form-control" id="pib" />
                    </div>
                    <div class="form-group">
                        <form:label path="telefon">Telefon</form:label>                                                               
                        <form:input path="telefon" class="form-control" id="telefon" />
                    </div>
                    <div class="form-group">
                        <form:label path="webStrana">Web strana</form:label>                                                               
                        <form:input path="webStrana" class="form-control" id="webStrana" />
                    </div>

                    <div class="form-group">
                        <form:label path="godinaOsnivanja">Godina osnivanja</form:label>                                                               
                        <form:input path="godinaOsnivanja" class="form-control" id="godinaOsnivanja" />
                    </div>
